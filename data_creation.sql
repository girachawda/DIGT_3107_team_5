...
-- 🎄 1. Highest revenue week (Christmas week with many expensive Presidential & Duplex rooms)
...
-- ☃️ 2. Double room (Duplex) availability check (various bookings on different dates)
...
-- 🎁 3. Staff discount tracking across years (2024 vs 2025)
...
-- 🛎️ 4. Daily check-in + check-out + cancellations mix
...
(10, 4, 1, '2024-12-22 08:45:00', '2024-12-24 16:00:00', '2024-12-27 10:00:00', FALSE, FALSE),
...
(4, 8, 2, '2024-12-24 14:30:00', '2024-12-26 14:00:00', '2024-12-31 10:00:00', TRUE, TRUE),
...
-- 😈 5. Frequent cancellation customer (The Grinch keeps cancelling)
...
-- 🏚️ 6. Rooms not booked in the last month (use room_id not room_number)
